...
# MAGIC To run this demo, just select the cluster `dbdemos-lakehouse-retail-c360-kaustav_paul` from the dropdown menu ([open cluster configuration](https://adb-984752964297111.11.azuredatabricks.net/#setting/clusters/0515-183149-c35afcfr/configuration)). <br />
...
# MAGIC %sql 
# MAGIC LIST '/Volumes/kaustavpaul_demo/lakehouse/c360/users'

# COMMAND ----------

# DBTITLE 1,Review the raw user data received as JSON
# MAGIC %sql
# MAGIC SELECT * FROM json.`/Volumes/kaustavpaul_demo/lakehouse/c360/users`
...
# MAGIC
# MAGIC
# MAGIC Switch to Databricks SQL to see how this data can easily be requested using <a href='/sql/dashboards/0fccee85-c44d-4538-a625-eea610a7efad' target="_blank">Churn prediction DBSQL dashboard</a>, or an external BI tool. 
# MAGIC
